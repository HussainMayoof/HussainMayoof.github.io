                ...
                socialLinks: fields.array(
                    fields.object({
                        ...
                        label: fields.text({
                            label: 'Aria Label',
                            description:
                                "Accessibility label (e.g., 'GitHub', 'Email')",
                            validation: { isRequired: true },
                        }),
                    }),
                    {
                        label: 'Social Links',
                        itemLabel: (props) =>
                            props.fields.label.value || 'New Link',
                ...
                extraLinks: fields.array(
                    fields.object({
                        link: fields.text({
                            label: 'Link URL',
                            description:
                                'URL or path (e.g., /blog or https://example.com)',
                            validation: { isRequired: true },
                        }),
                        icon: fields.select({
                            label: 'Icon',
                            description:
                                'Select an icon from Lucide icon library',
                            options: [
    ...
    collections: {
                        ...
                        YouTube: block({
                            ...
                            schema: {
                                id: fields.text({
                                    label: 'Video ID',
                                    description:
                                        'YouTube video ID (optional if URL is provided)',
                                }),
                                url: fields.text({
                                    label: 'YouTube URL',
                                    description:
                                        'Full YouTube URL (optional if ID is provided)',
                                }),
                            },
                        }),
                        Twitter: block({
                            ...
                            schema: {
                                ...
                                id: fields.text({
                                    label: 'Tweet ID',
                                    description:
                                        'Tweet ID (optional if URL is provided)',
                                }),
                                username: fields.text({
                                    label: 'Username',
                                    description:
                                        'Twitter username (optional if URL is provided)',
                                }),
                            },
                        }),
                    },
        ...
        skills: collection({
            ...
            schema: {
                ...
                logo: fields.image({
                    label: 'Skill Logo',
                    directory: 'src/assets/skills',
                    publicPath: '@assets/skills/',
                    description: 'Optional skill logo',
                }),
                colour: fields.select({
                    label: 'Colour',
                    options: [
                        { label: 'Black', value: '' },
                        { label: 'Purple', value: 'badge-primary' },
                        { label: 'Pink', value: 'badge-secondary' },
                        { label: 'Turquoise', value: 'badge-accent' },
                        { label: 'Blue', value: 'badge-info' },
                        { label: 'Green', value: 'badge-success' },
                        { label: 'Yellow', value: 'badge-warning' },
                        { label: 'Red', value: 'badge-error' },
                    ],
                    defaultValue: '',
                }),
