...
const skills = defineCollection({
    loader: glob({pattern: "**/*.{md,mdoc,yaml}", base: "./src/content/skills"}),
    schema: ({image}) =>
        z.object({
            title: z.string(),
            logo: image().optional(),
            colour: z.enum(["", "badge-primary", "badge-secondary", "badge-accent", "badge-info", "badge-success", "badge-warning", "badge-error"]),
